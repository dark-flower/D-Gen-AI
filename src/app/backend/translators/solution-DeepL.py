...
deepl_translator = deepl.Translator("1e6ca761-1246-4ab0-8814-1eaefe9a3575:fx")
...
def answer_user_question(question:str="this is a dummy question, don't answer it", source_lang:str='en'):
    ...
    if source_lang == 'ar':
        user_prompt =  deepl_translator.translate_text(user_prompt, target_lang="EN-US").text #argostranslate.translate.translate(question, to_code, from_code)
    print("Before")
    output = qa_lm({'query': user_prompt})
    print("After")
    if source_lang == 'ar':
        output['response'] = deepl_translator.translate_text(output['result'], target_lang="AR").text
    else:
